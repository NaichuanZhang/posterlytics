...
test('painter references are ordered style board, users, logo, then product', () => {
...
test('painter reference selection caps at six before logo and product overflow', () => {
  const selected = orderImageReferences([
    reference('logo', 'logo'),
    reference('product', 'product'),
