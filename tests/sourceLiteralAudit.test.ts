...
const SOURCE_LITERAL_ALLOWLIST: AllowedLiteral[] = [
  ...
  },
  {
    ...
    count: 1,
    category: 'brand-name',
    reason: 'Product brand mark in the recoverable application error screen.',
  },
  {
    file: 'src/components/AppErrorBoundary.tsx',
    kind: 'jsx-text',
    ...
    count: 1,
    category: 'brand-name',
    reason: 'Product name in the recoverable application error screen.',
  },
  {
  ...
  {
    file: 'src/components/SourceUrlsField.tsx',
    kind: 'visible-variable',
    text: 'https://yourproduct.com',
    count: 1,
    category: 'url',
    reason: 'Illustrative primary source URL placeholder for the first source row.',
  },
  {
    file: 'src/pages/CampaignWizardPage.tsx',
    kind: 'jsx-text',
