...
- **Posters**: every poster is the AI-painted `AiPoster`, sized by the dependency-free registry in `src/lib/posterSize.ts`. The default remains 980x1470 artwork on a 1240x1754 A4 sheet; a real scannable `QrCode` is composited in a descriptor-scaled branded bottom band.
